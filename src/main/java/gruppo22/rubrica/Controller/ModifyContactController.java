...
*/
    ...
    for (int i = 0; i < phoneNumberInputFields.size(); i++) {
        ...
        if (phoneNumberList.get(0) != null) {
            this.inputPhoneNumber_1.setText(phoneNumberList.get(0));
        }
        if (phoneNumberList.get(1) != null) {
            this.inputPhoneNumber_2.setText(phoneNumberList.get(1));
        }
        if (phoneNumberList.get(2) != null) {
            this.inputPhoneNumber_3.setText(phoneNumberList.get(2));
        }
