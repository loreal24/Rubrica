/**
 * @file Email.java
 * @brief This file contains the implementation of the Email features More
...
public class Email {
	 ...
	 * @param[in] emailList A List that contains a list of string that represent
	...
	/**
	 * @brief Allows to remove a String that represent the email of the contact
	 * from the list of email.
	 * @param[in] email A String that represents the email of the contact.
	 * @return A String that represents the email of the contact we have
	 * removed.
	 * @throws InvalidEmailException
	 */
	 ...
	 * @param[in] oldEmail A String that represents the email of the contact we
	 * want modify.
	 * @param[in] newEmail A String that represents the email of the contact we
	 * want set.
	 * @throws InvalidEmailException
	 */
