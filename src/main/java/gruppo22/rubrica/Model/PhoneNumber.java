 ...
 * @brief This file contains the implementation of the PhoneNumber features More
 * detailed information about the file and its role in the project
 * @author lpane
...
public class PhoneNumber {
	 ...
	 * @param[in] phoneNumbers A List that represent a list of string that
	 * represent the phonenumber of the contact.
	 */
	 ...
	 * @return A List of String that represent the list of phonenumber of the
	 * contact
	 */
	...
	/**
	 * @brief Allows to add a String that represents the phonenumber of the
	 * contact
	 * @param[in] phoneNumber A String that represent the phonenumber of the
	 * contact
	...
	/**
	 * @brief Allows to remove a phonenumber from the list of phonenumber of the
	 * contact
	 * @param[in] phoneNumber A String that represent the phonenumber of the
	 * contact
	 ...
	 * @param[in] oldPhoneNumber A String that represents the phonenumber we
	 * want modify
	 * @param[in] newPhoneNumber A String that represent the phonenumber we want
	 * set
	 * @throws InvalidPhoneNumberException
	 */
