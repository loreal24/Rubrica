...
public class Contact {
	...
	/**
	 * @brief Constructor
	 * @pre 'name!="" && surname!=""' The input name and surname cannot both be
	 * blank
	 *
	 * @param[in] name A String that represents the contact name
	 * @param[in] surname A String that represents the contact surname
	 * @param[in] email An object that represents the list of email of the
	 * contact
	 * @param[in] phoneNumber An object that represent the list of phonenumber
	 * of the contact
